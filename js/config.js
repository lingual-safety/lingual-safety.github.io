...
const CONFIG = {
  ...
  // Important dates
  dates: {
    registrationOpen: "To be announced",
    trainingDataRelease: "To be announced",
    developmentPhaseStart: "To be announced",
    developmentPhaseEnd: "To be announced",
    submissionDeadline: "To be announced",
    resultsLeaderboard: "To be announced",
    systemPaperDeadline: "To be announced",
